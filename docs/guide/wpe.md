...
若为旧版本(0.96.9.8及以下),请不要使用WPE中的过动态验证功能, 会导致虽然窗口关闭但仍然提示冻结账号

若开启过请关闭并重启WPE,清理缓存

请看[高级功能的动态验证功能](./advanced.md#过动态验证)
...
4. ~~改卡(调整改卡配置后,必须重启WPE并清理缓存. 卡在99% 说明名字打错了)~~ 改卡目前已失效, 敬请期待
...
先打开WPE,然后进入游戏, 去游戏里的背包勾选人物左侧的套装,如果开启成功,会得到一个爆率徽章Hero(在背包内,需要你自己装上),以及6级公会设施
