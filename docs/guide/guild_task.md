...
A:为了打前置关徽章.可以自行在"批量公会任务"配置处进行配置.

配置方法: 桌面版主程序, 右中间, 编辑账号下方的"进阶功能"中, 选择"自挂功能", 选择自动公会任务, 新打开的窗口的右下角的"房间配置"可以进行配置

---

Q: 如何自定义配置某个账号用哪个卡组?

A: 自0.96.9.23版本起, 在桌面版右中部, 点击 "打开配置工具", 选择"批量配置", 选中你要修改的账号, 配置名称填入"公会任务_卡组" , 如果你要指定第3个卡组, 配置值就填3, 然后保存即可. 
...
<!-- **如果你是0.96.8.5以上的版本, 更新时不会自动覆盖task.ini文件, 可以放心修改及更新** -->

建议自行使用 [桌面版配置工具](./config.md) 自动导出软件相关配置, 方便迁移也避免丢失你的专属配置
