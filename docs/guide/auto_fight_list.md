...
|绑定温馨礼包| (需至少是0.96.9.0以上版本的桌面版) 操作=绑定温馨礼包 即可,无需其他参数 自动绑定后, 领取链接的末尾是对应游戏的账号_区服号码 如: account_1 |
|领取温馨礼包| (需至少是0.96.9.0以上版本的桌面版) 自动领取温馨礼包, 若你已在温馨礼包.txt中填入,则无需本条命令, 本命令无效.|
