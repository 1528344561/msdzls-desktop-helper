...
由于人数多, 我是不可能一个一个去给你们讲怎么使用的, 使用方面的问题通过群内以及查文档大部分都能解决. 文档我会尽量详细地写. 如果有BUG可以直接反馈, 这个是没关系的.
...
2. 1级即可进行VIP签到,方便批量起小号刷VIP(需账户内点数>=8, 24小时扣1次, 与账号数量无关)
3. 星三神(需账户内点数>=1, 24小时扣1次, 与账号数量无关)

#### 获取点数

在下单vip的时候, 切换商品可以选择点卡, 1块钱100点数
...
联系Q:2254399813购买 (无手续费,因为人数多,每次发一个月会很麻烦, 购买少于三个月请到自助网站购买)
...
若你开启了自动登录VIP版本, 可在进入桌面版后的右下角关闭 "自动登录VIP版本" 

然后重进软件, 在VIP登录页面的续费充值页面就可以找到.
